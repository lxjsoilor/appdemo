            ...
            <li v-for="(foodItem,index) in goodItem.foods">
              ...
              <div class="food-context">
                ...
                <div class="change-goods-number">
                  ...
                  <a href="javascript:;" class=" icon-add_circle link-change add" @click="addFoods(idx+'-'+index,foodItem,index,$event)"></a>
                </div>
              </div>
            </li>
          </ul>
    ...
    export default {
        ...
        methods: {
            ...
            addFoods(idx, item, index, event) {
                ...
                this.$store.commit("ballMove", rect);
            },
            cutFoods(idx) {
                let product = this.$store.getters.getProductById(idx);
                if (product) {
